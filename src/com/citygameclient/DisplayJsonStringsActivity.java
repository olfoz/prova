...
public class DisplayJsonStringsActivity extends ListActivity {
	...
	ArrayList<String> personArray =new ArrayList<String>();
	 ...
	 @Override
	  public void onCreate(Bundle savedInstanceState) {
	    ...
	    setListAdapter(new ArrayAdapter<String>(this, android.R.layout.simple_list_item_1, JSONParser(inputString)));
	...
	private ArrayList<String> JSONParser(String JSONSource){
